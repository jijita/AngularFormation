angular.module('app', ['ngRoute', 'ngMaterial']);
  ...
  .config(['$routeProvider', '$locationProvider', function ($routeProvider, $locationProvider) {
    $routeProvider.
      when('/', { templateUrl: 'pageMontreal.html', controller: 'montrealController' }).
      when('/city', { templateUrl: 'pageCity.html', controller: 'cityController' }).
  ...
  .controller('montrealController', function ($scope, $http) {
    ...
    $scope.init = function () {
      var url = "http://api.openweathermap.org/data/2.5/weather?q=Montreal&APPID=602069103349fb71ec61fece71d05371";
      $http.get(url)
